...
<body id="app-layout" style="background-image: url('images/img/cicago2.jpg'); width: 0px;">
	<nav class="navbar navbar-default navbar-static-top">
	<div class="container">
		<div class="navbar-header" >
			<s:a action="index" namespace="" class="navbar-brand">
				<span class="glyphicon glyphicon-chevron-left" style="color:white;"> Quay về trang chủ </span></s:a>
			</a>
		</div>
	</div>
	</nav>
	...
	<div class="container">
		<div class="row mamnn" style="margin-left: 12em;">
			<div class="col-md-8 col-md-offset-2">
				<div class="panel panel-default">
					<div class="panel-heading">Đăng nhập tài khoản</div>
					<div class="panel-body" style="background-color: #c5d1d6;" >
						<s:fielderror />
						<s:form action="login" class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-md-6">
									<s:textfield name="user.email" type="email"
										 class="form-control" />
							...
							<div class="form-group">
								<div class="col-md-6 col-md-offset-4">
									...
									<s:a action="adduser">
									<button type="button" class="btn btn-primary pull-right">Đăng ký</button>
									</s:a>
